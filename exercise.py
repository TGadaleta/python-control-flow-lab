...
def weather_advice():
    # Your control flow logic goes here
    temp = input("Is it cold out? y or n: ")
    temp = True if temp == 'y' else False
    rain = input("Is it raining? y or n: ")
    rain = True if rain == 'y' else False
    if temp and rain:
        print("Wear a waterproof coat.")
    elif temp and not rain:
        print("Wear a warm coat.")
    elif not temp and rain:
        print("Carry an umbrella.")
    elif not temp and not rain:
...
def determine_season():
    # Your control flow logic goes here
    # I got some help from Chat-GPT for creating the dictionary, the rest was me
    seasons = {
    ...
    for season, date_range in seasons.items():
        for m, start, end in date_range:
            if m == month and start <= day <= end:
               return print(f'{month} {day} is in {season}')
...
def guess_number():
    ...
    for guess in range(5):
        ...
        if guess == 3:
            print("Last chance!")
        if guess == 4:
            print(f"Sorry, you failed to guess the number in five attempts. The number is {num}")
